...
Claim id: `taxon-spelling-variant-audit`
...
Observed payload: [`taxon-spelling-variant-audit.json`](./block-payloads/taxon-spelling-variant-audit.json)

### Taxonomic synonym candidate detection

Claim id: `taxonomic-synonym-candidate-detection`
...
Observed payload: [`taxonomic-synonym-candidate-detection.json`](./block-payloads/taxonomic-synonym-candidate-detection.json)

### Controlled synonym resolution

Claim id: `controlled-synonym-resolution`
...
Observed payload: [`controlled-synonym-resolution.json`](./block-payloads/controlled-synonym-resolution.json)

### Ambiguous synonym rejection

Claim id: `ambiguous-synonym-rejection`
...
Observed payload: [`ambiguous-synonym-rejection.json`](./block-payloads/ambiguous-synonym-rejection.json)

### Taxon namespace classification

Claim id: `taxon-namespace-classification`
...
Observed payload: [`taxon-namespace-classification.json`](./block-payloads/taxon-namespace-classification.json)

### Mixed namespace detection

Claim id: `mixed-namespace-detection`
...
Observed payload: [`mixed-namespace-detection.json`](./block-payloads/mixed-namespace-detection.json)

### Taxon crosswalk table

Claim id: `taxon-crosswalk-table`
...
Observed payload: [`taxon-crosswalk-table.json`](./block-payloads/taxon-crosswalk-table.json)

### Taxon exclusion reasoning

Claim id: `taxon-exclusion-reasoning`
...
Observed payload: [`taxon-exclusion-reasoning.json`](./block-payloads/taxon-exclusion-reasoning.json)

### Workflow taxon-loss report

Claim id: `workflow-taxon-loss-report`
...
Observed payload: [`workflow-taxon-loss-report.json`](./block-payloads/workflow-taxon-loss-report.json)

### Taxon stability report

Claim id: `taxon-stability-report`
...
Observed payload: [`taxon-stability-report.json`](./block-payloads/taxon-stability-report.json)
