...
- `downgraded_to_bounded`: `4`
- `supported_with_limits`: `2`

## Claims

- `repository-overview-runtime-breadth` — `downgraded_to_bounded`
  Path: `README.md`
  Claim: The repository provides runtime surfaces for phylogenetic validation, alignment diagnostics, comparative analysis, and reviewable reporting.
...
- `repository-overview-evidence-book` — `supported_with_limits`
  Path: `README.md`
  Claim: The evidence-book is a first-class checked-in trust surface rather than a transient artifact dump.
...
- `docs-home-runtime-workbench` — `downgraded_to_bounded`
  Path: `docs/index.md`
