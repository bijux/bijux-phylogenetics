...
- summary: Comparative workflows are the strongest evidence-grounded surface in the repository, but transformed-tree and ancestral parity still retain explicit coverage boundaries and the broader comparative surface is not yet closed.
