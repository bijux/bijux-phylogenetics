...
_DATASET_ID = "avian_reproductive_traits"
_DATASET_LABEL = "Avian reproductive trait dataset"
_TAXON_COLUMN = "species"
_CONTINUOUS_TRAIT = "testes_mass"
_PGLS_PREDICTOR = "body_mass"
_DISCRETE_TRAIT = "mating_system"
_CLADE_TRAIT = "mating_system"
...
def load_avian_reproductive_trait_dataset() -> AvianReproductiveTraitDataset:
    ...
    return AvianReproductiveTraitDataset(
        ...
        workflow_clade_trait=_CLADE_TRAIT,
        source_summary=(
...
def run_avian_reproductive_trait_workflow() -> AvianReproductiveTraitWorkflowReport:
    """Run the owned comparative workflow over the packaged avian dataset."""
    dataset = load_avian_reproductive_trait_dataset()
    pgls = run_pgls(
        dataset.tree_path,
        dataset.traits_path,
    ...
    return AvianReproductiveTraitWorkflowReport(
        dataset=dataset,
        pgls=pgls,
        brownian=brownian,
        ou=ou,
...
def write_avian_reproductive_trait_workflow_bundle(
    output_root: Path, report: AvianReproductiveTraitWorkflowReport
) -> AvianReproductiveTraitWorkflowBundle:
    """Write the governed comparative workflow outputs for the packaged avian dataset."""
    ...
    return AvianReproductiveTraitWorkflowBundle(
...
def _write_workflow_summary_table(
    path: Path, report: AvianReproductiveTraitWorkflowReport
) -> Path:
    slope = next(
        coefficient
