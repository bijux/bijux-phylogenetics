        ...
        rows=[
            {
                ...
                "transform": case.scenario.transform or "",
...
def write_discrete_mode_recovery_parameter_table(
    path: Path,
    report: DiscreteModeRecoveryReport,
) -> Path:
    """Write all truth-versus-fit transform-parameter recovery rows."""
    return write_taxon_rows(
        path,
        columns=[
            "case_id",
...
def write_discrete_mode_recovery_parameter_comparison_table(
    path: Path,
    report: DiscreteModeRecoveryReport,
) -> Path:
    """Write paired Bijux-versus-geiger transform-parameter recovery rows."""
    return write_taxon_rows(
        path,
        columns=[
            "case_id",
