...
from bijux_phylogenetics.phylogeography.continuous_coordinates import summarize_continuous_phylogeography
...
from bijux_phylogenetics.phylogeography.geographic_map_review.shared import (
    active_line_counts as _active_line_counts,
    apply_depth_filter as _apply_depth_filter,
    branch_midpoint_depth as _branch_midpoint_depth,
    build_discrete_line_rows as _build_discrete_line_rows,
    build_discrete_node_markers as _build_discrete_node_markers,
    build_discrete_tip_markers as _build_discrete_tip_markers,
    build_map_summary as _build_map_summary,
    continuous_depths as _continuous_depths,
    format_optional_float as _format_optional_float,
    load_region_centroids as _load_region_centroids,
    validate_depth_filters as _validate_depth_filters,
)
