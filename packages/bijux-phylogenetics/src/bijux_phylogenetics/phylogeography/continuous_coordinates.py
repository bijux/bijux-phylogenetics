...
@dataclass(slots=True)
class _PreparedCoordinateDataset:
    taxon_column: str
...
def _prepare_coordinate_dataset(
    tree_path: Path,
    table_path: Path,
    *,
    latitude_column: str,
    ...
    return _PreparedCoordinateDataset(
...
def _write_filtered_coordinate_table(
    path: Path,
