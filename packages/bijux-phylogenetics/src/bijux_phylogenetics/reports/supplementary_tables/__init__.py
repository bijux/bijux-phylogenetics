...
def write_supplementary_batch_summary_table(
    ...
    *,
    ...
    from .batch_summary import (
        write_supplementary_batch_summary_table as write_batch_summary_table_impl,
    )

    return write_batch_summary_table_impl(path, workflow_bundle_root=workflow_bundle_root)
