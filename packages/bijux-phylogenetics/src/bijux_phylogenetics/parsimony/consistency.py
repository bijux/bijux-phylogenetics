...
def consistency_index(
    ...
    *,
    ...
    for character_id in resolved_matrix.character_ids:
        ...
        minimum_possible_steps = _minimum_possible_steps(
            resolved_method,
            observed_states,
        ...
        character_kind = _character_kind(resolved_matrix, character_id, observed_states)
        if minimum_possible_steps == 0.0 and observed_steps == 0.0:
            ...
            character_rows.append(
                ParsimonyConsistencyCharacterIndex(
                    ...
                    minimum_possible_steps=minimum_possible_steps,
        ...
        minimum_possible_steps_total += minimum_possible_steps
        ...
        character_rows.append(
            ParsimonyConsistencyCharacterIndex(
                ...
                minimum_possible_steps=minimum_possible_steps,
                observed_steps=observed_steps,
                consistency_index=minimum_possible_steps / observed_steps,
...
def _minimum_possible_steps(
    ...
    *,
    ...
    raise ParsimonyAnalysisError(
        "consistency index minimum-step calculation requires one supported method",
        code="parsimony_consistency_index_method_unknown",
