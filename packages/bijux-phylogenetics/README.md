...
- optimize fixed-topology nucleotide substitution parameters through one selected JC69, K80, HKY85, or GTR surface that records model-specific starts, search bounds, convergence state, boundary warnings, and governed recovery behavior instead of hardcoding one parameter set per model
