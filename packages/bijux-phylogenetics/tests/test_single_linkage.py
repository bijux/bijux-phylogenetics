...
def test_build_single_linkage_tree_does_not_delegate_to_average_linkage(
    ...
    def _boom(*_args: object, **_kwargs: object) -> object:
        raise AssertionError("single-linkage must not call average-linkage builder")

    monkeypatch.setattr(average_linkage_module, "build_average_linkage_tree", _boom)
    tree, report = build_single_linkage_tree(identifiers, lookup)
