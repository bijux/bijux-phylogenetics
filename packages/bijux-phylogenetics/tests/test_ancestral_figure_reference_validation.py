...
def test_validate_ancestral_figure_reference_fixtures_governs_uncertainty_visibility() -> None:
    ...
    assert observed["continuous_intervals_visible"].observed["publication_ready"] is True
    assert observed["continuous_intervals_visible"].observed["uncertainty_visible"] is True
    assert (
