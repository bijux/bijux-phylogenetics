...
def test_validate_alignment_figure_reference_fixtures_governs_publication_audits() -> None:
    ...
    assert observed["clean_alignment_quality_figures_ready"].observed[
        "publication_ready"
    ] is True
    assert observed["missingness_alignment_quality_figures_blocked"].observed[
        "publication_ready"
    ] is False
    assert observed["missingness_alignment_quality_figures_blocked"].observed[
