...
def test_replay_fixed_topology_dna_run_manifest_rejects_input_checksum_drift(
    ...
    tree_copy.write_text(
        fixture("trees", "hky85_likelihood_tree_2_taxa.nwk").read_text(encoding="utf-8"),
        encoding="utf-8",
    )
    ...
    assert error_info.value.code == "bayesian_run_manifest_replay_input_checksum_mismatch"
